...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-amber-400 shadow-sm sticky top-0 z-50">
      ...
      <div className="navbar-end">
        ...
        {user ? (
          <div className="dropdown dropdown-end ml-4">
            ...
            >
              <li>
                <a onClick={() => navigate("/dashboard/profile")}>Dashboard</a>
              </li>
              <li>
          ...
          <>
            <Link to="register" className="btn btn-soft btn-warning ml-4">
              Register
            </Link>
            <Link to="login" className="btn btn-soft btn-success ml-4">
              Login
            </Link>
          </>
        )}
