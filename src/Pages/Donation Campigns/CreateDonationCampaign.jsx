...
//   // Replace with your Cloudinary or imgbb API key and upload URL
...
//       const response = await axios.post('/api/donation-campaigns', campaignData);
...
import React, { useState } from 'react';
import axios from 'axios';
import useAuth from '../../Hooks/useAuth'; // ✅ import user context
